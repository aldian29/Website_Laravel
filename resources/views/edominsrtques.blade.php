    ...
    <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="margin-top: 30px;background-color: whitesmoke;">
                <div class="card-body">
                  ...
                  <form action="/saveq" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Kode quesioner</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="xidq" placeholder="Silahkan isi..">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Pertanyaan</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="xpert" placeholder="Silahkan isi..">
                      </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">jenis pertanyaan</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="xjenis" placeholder="Silahkan isi..">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Status pertanyaan</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="xsts" placeholder="Silahkan isi..">
                        </div>
                      </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
