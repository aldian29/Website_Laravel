                ...
                <div class="card-body">
                  ...
                  <form action="/updetmk/{{$mk->id_matkul}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="hidden" class="form-control" name="xid"value="{{$mk->id_matkul}}">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama Matkul</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="xnamamk"value="{{$mk->nama_matkul}}">
                      </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">SKS Matkul</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="xsks"value="{{$mk->sks_matkul}}">
                        </div>
                      </div>
                      <div class="form-group row">
