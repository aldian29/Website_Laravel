              ...
              <div class="card" style="margin-top: 30px;background-color: whitesmoke;">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Tambah Data Dosen <code>TRPL</code>
                  </p><hr>
                  ...
                  <form action="/save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="xnidn" placeholder="Silahkan isi..">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="xnama" placeholder="Silahkan isi..">
                      </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">alamat</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="xalamat" placeholder="Silahkan isi..">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Jenis Kelamin</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="xjk" placeholder="Silahkan isi..">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Bidang Keahlian</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="xbidang" placeholder="Silahkan isi..">
                        </div>
                      </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
